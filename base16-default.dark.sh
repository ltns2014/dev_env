...
color01="e0/42/2d" # Base 08 - Red
color02="3d/99/70" # Base 0B - Green
color03="ff/dc/00" # Base 0A - Yellow
color04="00/74/d9" # Base 0D - Blue
color05="b1/0d/c9" # Base 0E - Magenta
color06="39/cc/cc" # Base 0C - Cyan
color07="ed/e5/da" # Base 05 - White
color08="50/50/50" # Base 03 - Bright Black
color09=$color01 # Base 08 - Bright Red
color10="2e/cc/40" # Base 0B - Bright Green
color11=$color03 # Base 0A - Bright Yellow
color12="00/74/d9" # Base 0D - Bright Blue
color13="b1/0d/c9" # Base 0E - Bright Magenta
color14="7f/db/ff" # Base 0C - Bright Cyan
color15="ed/e5/da" # Base 07 - Bright White
color16="ff/85/1b" # Base 09
color17="ad/47/42" # Base 0F
color18="20/20/20" # Base 01
color19="30/30/30" # Base 02
color20="b0/b0/b0" # Base 04
color21="ed/e5/da" # Base 06
